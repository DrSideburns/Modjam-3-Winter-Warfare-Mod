...
public class BlockFrozenPumpkin extends BlockDirectional
{
    ...
    protected BlockFrozenPumpkin(int par1, boolean par2)
    {
    ...
    public void onBlockAdded(World par1World, int par2, int par3, int par4)
    {
        ...
        else if (par1World.getBlockId(par2, par3 - 1, par4) == Block.ice.blockID && par1World.getBlockId(par2, par3 - 2, par4) == Block.ice.blockID)
        {
            if (!par1World.isRemote)
            {
                par1World.setBlock(par2, par3, par4, 0, 0, 2);
                par1World.setBlock(par2, par3 - 1, par4, 0, 0, 2);
                par1World.setBlock(par2, par3 - 2, par4, 0, 0, 2);
                EntityIceGolem entitysnowman = new EntityIceGolem(par1World);
                entitysnowman.setLocationAndAngles((double)par2 + 0.5D, (double)par3 - 1.95D, (double)par4 + 0.5D, 0.0F, 0.0F);
                par1World.spawnEntityInWorld(entitysnowman);
                par1World.notifyBlockChange(par2, par3, par4, 0);
                par1World.notifyBlockChange(par2, par3 - 1, par4, 0);
    ...
    {
        this.field_94475_c = par1IconRegister.registerIcon(this.getTextureName() + "_face");
