...
public class EntityAbominableSnowman extends EntityMob implements IRangedAttackMob {
	...
	public EntityAbominableSnowman(World par1World) {
	 ...
	 public void attackEntityWithRangedAttack(EntityLivingBase par1EntityLivingBase, float par2)
	    {
	        EntityHardSnowball entitysnowball = new EntityHardSnowball(this.worldObj, this);
