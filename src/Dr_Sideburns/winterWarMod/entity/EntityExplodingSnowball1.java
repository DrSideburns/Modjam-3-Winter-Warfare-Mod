...
public abstract class EntityExplodingSnowball1 extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityExplodingSnowball1(World par1World)
    {
        super(par1World);
    ...
    public EntityExplodingSnowball1(World par1World, EntityLivingBase par2EntityLivingBase)
    {
        super(par1World);
    ...
    public EntityExplodingSnowball1(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
