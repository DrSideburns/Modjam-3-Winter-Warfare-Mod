...
public class EntityLaunchedSlimeball extends Entity implements IProjectile
{
    private int xTile = -1;
    private int yTile = -1;
    private int zTile = -1;
    ...
    public EntityLaunchedSlimeball(World par1World)
    {
        super(par1World);
    ...
    public EntityLaunchedSlimeball(World par1World, double par2, double par4, double par6)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.setSize(0.5F, 0.5F);
    ...
    public EntityLaunchedSlimeball(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityLaunchedSlimeball(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLivingBase;
    ...
    public void onUpdate()
    {
        ...
        else
        {
            ...
            float ff = 0.25F;
            this.worldObj.spawnParticle("slime", this.posX - this.motionX * (double)ff, this.posY - this.motionY * (double)ff, this.posZ - this.motionZ * (double)ff, this.motionX, this.motionY, this.motionZ);
            this.worldObj.spawnParticle("slime", this.posX - this.motionX * (double)ff, this.posY - this.motionY * (double)ff, this.posZ - this.motionZ * (double)ff, this.motionX, this.motionY, this.motionZ);
            this.worldObj.spawnParticle("slime", this.posX - this.motionX * (double)ff, this.posY - this.motionY * (double)ff, this.posZ - this.motionZ * (double)ff, this.motionX, this.motionY, this.motionZ);
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    if (this.shootingEntity == null)
                    {
                        ...
                        damagesource = WWDamageSource.causeLaunchedSlimeballDamage(this, this);
                        movingobjectposition.entityHit.worldObj.setBlock(((int)movingobjectposition.entityHit.posX), ((int)movingobjectposition.entityHit.posY), ((int)movingobjectposition.entityHit.posZ), Block.web.blockID);
                    	}
                    	}
                    else
                    {
                    	if(!(movingobjectposition.entityHit instanceof EntityPlayer)) {
                        damagesource = WWDamageSource.causeLaunchedSlimeballDamage(this, this.shootingEntity);
                        movingobjectposition.entityHit.worldObj.setBlock(((int)movingobjectposition.entityHit.posX), ((int)movingobjectposition.entityHit.posY), ((int)movingobjectposition.entityHit.posZ), Block.web.blockID);
                    }
                    }
